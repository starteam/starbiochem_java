...
public abstract class AdjustMoleculeUIContainer_generated extends javax.swing.JPanel implements molecule.ui.signal.AdjustInfoRaiser, star.event.EventController, star.event.Listener
{
	private star.event.Adapter adapter;
	private java.util.prefs.Preferences preferences = null;
	private static final long serialVersionUID = 1L;

	public  AdjustMoleculeUIContainer_generated()
	{
		super();
	}
	 
	public  AdjustMoleculeUIContainer_generated(boolean boolean0)
	{
		super( boolean0);
	}
	 
	public  AdjustMoleculeUIContainer_generated(java.awt.LayoutManager layoutManager, boolean boolean0)
	{
		super( layoutManager,boolean0);
	}
	 
	public  AdjustMoleculeUIContainer_generated(java.awt.LayoutManager layoutManager)
	{
		super( layoutManager);
	}
	...
	public java.util.prefs.Preferences getPreferences()
	{
		if( preferences == null )
		{
			...
			{
				plugin.preferences.Preferences pref = (plugin.preferences.Preferences) plugin.Loader.getDefaultLoader().getPlugin(plugin.preferences.Preferences.class.getName(), plugin.preferences.PreferencesImplementation.class.getName());
				this.preferences = pref.getPreferences("molecule.ui.adjust.AdjustMoleculeUIContainer");
			}
			catch( plugin.PluginException ex )
			{
				ex.printStackTrace();
