...
public abstract class WaterFiltersPanel_generated extends javax.swing.JPanel implements star.event.EventController
{
	private star.event.Adapter adapter;
	private java.util.prefs.Preferences preferences = null;
	private static final long serialVersionUID = 1L;

	public  WaterFiltersPanel_generated()
	{
		super();
	}
	 
	public  WaterFiltersPanel_generated(boolean boolean0)
	{
		super( boolean0);
	}
	 
	public  WaterFiltersPanel_generated(java.awt.LayoutManager layoutManager, boolean boolean0)
	{
		super( layoutManager,boolean0);
	}
	 
	public  WaterFiltersPanel_generated(java.awt.LayoutManager layoutManager)
	{
		super( layoutManager);
	}
	...
	public java.util.prefs.Preferences getPreferences()
	{
		if( preferences == null )
		{
			...
			{
				plugin.preferences.Preferences pref = (plugin.preferences.Preferences) plugin.Loader.getDefaultLoader().getPlugin(plugin.preferences.Preferences.class.getName(), plugin.preferences.PreferencesImplementation.class.getName());
				this.preferences = pref.getPreferences("molecule.ui.water.WaterFiltersPanel");
			}
			catch( plugin.PluginException ex )
			{
				ex.printStackTrace();
