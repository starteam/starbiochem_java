...
@SignalComponent(extend=PropertyControls.class, raises={WaterSizeRaiser.class})
public class WaterSizePropertyControls extends WaterSizePropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public WaterSizePropertyControls(String name, int min, int max, int value)
    {
