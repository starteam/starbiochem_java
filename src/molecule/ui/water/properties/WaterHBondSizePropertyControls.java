...
@SignalComponent(extend=PropertyControls.class, raises={WaterHBondSizeRaiser.class})
public class WaterHBondSizePropertyControls extends WaterHBondSizePropertyControls_generated
{
    private static final long serialVersionUID = 1L;

    public WaterHBondSizePropertyControls(String name, int min, int max, int value)
    {
	...
	{		
		this.raise_WaterHBondSizeEvent();
	}
