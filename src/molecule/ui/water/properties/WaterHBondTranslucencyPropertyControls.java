...
@SignalComponent(extend=PropertyControls.class, raises={WaterHBondTranslucencyRaiser.class})
public class WaterHBondTranslucencyPropertyControls extends WaterHBondTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public WaterHBondTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_WaterHBondTranslucencyEvent();
	}
