...
@SignalComponent(extend=PropertyControls.class, raises={HeteroTranslucencyRaiser.class})
public class HeteroTranslucencyPropertyControls extends HeteroTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public HeteroTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_HeteroTranslucencyEvent();
	}
