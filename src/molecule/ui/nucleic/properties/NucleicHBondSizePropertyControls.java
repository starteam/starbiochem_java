...
@SignalComponent(extend=PropertyControls.class, raises={NucleicHBondSizeRaiser.class})
public class NucleicHBondSizePropertyControls extends NucleicHBondSizePropertyControls_generated
{
    private static final long serialVersionUID = 1L;

    public NucleicHBondSizePropertyControls(String name, int min, int max, int value)
    {
	...
	{		
		this.raise_NucleicHBondSizeEvent();
	}
