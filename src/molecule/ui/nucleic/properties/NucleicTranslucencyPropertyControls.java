...
@SignalComponent(extend=PropertyControls.class, raises={NucleicTranslucencyRaiser.class})
public class NucleicTranslucencyPropertyControls extends NucleicTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public NucleicTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_NucleicTranslucencyEvent();
	}
