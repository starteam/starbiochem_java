...
public abstract class StructurePanel_generated extends javax.swing.JTabbedPane implements star.event.EventController
{
	private star.event.Adapter adapter;
	private java.util.prefs.Preferences preferences = null;
	private static final long serialVersionUID = 1L;

	public  StructurePanel_generated()
	{
		super();
	}
	 
	public  StructurePanel_generated(int int0, int int1)
	{
		super( int0,int1);
	}
	 
	public  StructurePanel_generated(int int0)
	{
		super( int0);
	}
	...
	public java.util.prefs.Preferences getPreferences()
	{
		if( preferences == null )
		{
			...
			{
				plugin.preferences.Preferences pref = (plugin.preferences.Preferences) plugin.Loader.getDefaultLoader().getPlugin(plugin.preferences.Preferences.class.getName(), plugin.preferences.PreferencesImplementation.class.getName());
				this.preferences = pref.getPreferences("molecule.ui.StructurePanel");
			}
			catch( plugin.PluginException ex )
			{
				ex.printStackTrace();
