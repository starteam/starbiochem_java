...
@SignalComponent(extend=PropertyControls.class, raises={HeteroSizeRaiser.class})
public class HeteroSizePropertyControls extends HeteroSizePropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public HeteroSizePropertyControls(String name, int min, int max, int value)
    {
