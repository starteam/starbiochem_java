...
@SignalComponent(extend=PropertyControls.class, raises={HeteroHBondTranslucencyRaiser.class})
public class HeteroHBondTranslucencyPropertyControls extends HeteroHBondTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public HeteroHBondTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_HeteroHBondTranslucencyEvent();
	}
