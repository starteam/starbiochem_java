...
@SignalComponent(extend=PropertyControls.class, raises={NucleicHBondTranslucencyRaiser.class})
public class NucleicHBondTranslucencyPropertyControls extends NucleicHBondTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public NucleicHBondTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_NucleicHBondTranslucencyEvent();
	}
