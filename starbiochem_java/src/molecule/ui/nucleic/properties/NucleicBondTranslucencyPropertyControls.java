...
@SignalComponent(extend=PropertyControls.class, raises={NucleicBondTranslucencyRaiser.class})
public class NucleicBondTranslucencyPropertyControls extends NucleicBondTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public NucleicBondTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_NucleicBondTranslucencyEvent();
	}
