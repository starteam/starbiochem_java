...
@SignalComponent(extend=PropertyControls.class, raises={WaterBondTranslucencyRaiser.class})
public class WaterBondTranslucencyPropertyControls extends WaterBondTranslucencyPropertyControls_generated
{
    private static final long serialVersionUID = 1L;

	public WaterBondTranslucencyPropertyControls(String name, int min, int max, int value)
    {
	...
	{
		this.raise_WaterBondTranslucencyEvent();
	}
