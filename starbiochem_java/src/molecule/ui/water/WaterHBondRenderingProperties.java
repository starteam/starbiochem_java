...
import molecule.ui.water.properties.WaterHBondSizePropertyControls;
import molecule.ui.water.properties.WaterHBondTranslucencyPropertyControls;
import star.annotations.SignalComponent;

@SignalComponent(extend=AbstractAtomRenderingProperties.class, raises={})
public class WaterHBondRenderingProperties extends WaterHBondRenderingProperties_generated
{
	private static final long serialVersionUID = 1L;
	private static final String PROTEIN = "Selected amino acids"; //$NON-NLS-1$
	
	private WaterHBondSizePropertyControls size = null;
	private WaterHBondTranslucencyPropertyControls translucency = null;
	
	public WaterHBondRenderingProperties(Molecule molecule)
	{
		super();
	}
	...
	private void init()
	{
		...
		constraints.gridy = 0;
		size = new WaterHBondSizePropertyControls(hbond_size_string, minsize, maxsize, this.selectedSize);
		addPropertyControls(size, constraints);

		constraints.gridy = 1;
		translucency = new WaterHBondTranslucencyPropertyControls(hbond_translucency_string, minscale, maxscale, this.selectedTranslucency);
